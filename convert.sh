...
pandoc -f markdown -s src/routes/proj-stitch-strata.svx -o docx/4.1-stitch-strata.docx
pandoc -f markdown -s src/routes/proj-annealing-strategies.svx -o docx/4.2-annealing-strategies.docx
pandoc -f markdown -s src/routes/proj-refracted-touch.svx -o docx/4.3-refracted-touch.docx
pandoc -f markdown -s src/routes/proj-reconstruction-error.svx -o docx/4.4-reconstruction-error.docx
pandoc -f markdown -s src/routes/proj-electromagnetic.svx -o docx/4.5-electromagnetic.docx
...
# Tech
pandoc -f markdown -s src/routes/tech.svx -o docx/5-tech.docx
...
pandoc -s __sapper__/export/references/index.html -o docx/7-references-and-links.docx
